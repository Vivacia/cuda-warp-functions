__kernel void match_all_sync(unsigned mask, __local int* value, int *pred,
...
__kernel void test_match_all_sync_custom_true(int arg, __local int match_all_sync_shared_var_arr[],
    __local int match_all_sync_updated[]) {
    int pred[1] = {0};
    __local int ret;
    match_all_sync(0xffffffff, arg, pred, match_all_sync_shared_var_arr, match_all_sync_updated, &ret);
