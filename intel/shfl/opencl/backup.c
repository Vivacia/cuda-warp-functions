...
int main(int argc, char* argv[]) {
    ...
    for (int i = 0; i < 1/*NUM_ROUNDS*/; i++) {
        ...
        zeKernelSetArgumentValue(hKernel, 0, sizeof(unsigned)*32, shfl_up_sync_shared_var_arr);
        zeKernelSetArgumentValue(hKernel, 1, sizeof(unsigned)*32, shfl_up_sync_updated);
