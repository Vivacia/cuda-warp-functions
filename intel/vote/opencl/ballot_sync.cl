__kernel void ballot_sync(unsigned mask, int predicate,
...
__kernel void test_ballot_sync_custom_two(__local int ballot_sync_shared_var_arr[],
    ...
    ballot_sync(0xffffffff, tid % 2, ballot_sync_shared_var_arr,
...
__kernel void test_ballot_sync_custom_four(__local int ballot_sync_shared_var_arr[],
    ...
    int tid = get_global_id(0);
    __local unsigned ret;
    ballot_sync(0xffffffff, tid % 4, ballot_sync_shared_var_arr, ballot_sync_updated, &ret);
